...
class D05Test {
    ...
    void testFindSeat() throws Exception {
        D05 d = new D05();
        MatcherAssert.assertThat(d.findSeat("FBFBBFFRLR"), is(357));
        MatcherAssert.assertThat(d.findSeat("BFFFBBFRRR"), is(567));
        MatcherAssert.assertThat(d.findSeat("FFFBBBFRRR"), is(119));
        MatcherAssert.assertThat(d.findSeat("BBFFBBFRLL"), is(820));
    }
