...
class D04Test {
    ...
    void testValidateOnePassport(){
        D04 d = new D04();
        assertThat(d.validatePassport("ecl:gry pid:860033327 eyr:2020 hcl:#fffffd byr:1937 iyr:2017 cid:147 hgt:183cm"),is(true));
    ...
    void testScanPassport() throws Exception {
        ...
        assertThat(d.scanPassport(f), is(2));
    }
    ...
    void testInvalidPassport() throws Exception {
        ...
        assertThat(d.scanPassport(f), is(0));
    }
    ...
    void testValidPassport() throws Exception {
        ...
        assertThat(d.scanPassport(f), is(4));
    }
