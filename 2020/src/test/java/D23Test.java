...
class D23Test {
    ...
    void testGame() throws Exception {
        D23 d = new D23();
        assertThat(d.simulate("389125467", 1),is("328915467"));
        assertThat(d.simulate("389125467", 2),is("325467891"));
        assertThat(d.simulate("389125467", 3),is("725891346"));
        assertThat(d.simulate("389125467", 10),is("192658374"));
        assertThat(d.simulate("389125467", 100),is("167384529"));
    }
    ...
    void findContiguous() throws Exception {
        ...
        assertThat(d.findContiguous(input,5),is(62L));
    }
